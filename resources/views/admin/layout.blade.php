...
<li class="@yield('dashboard_select')">
    ...
    <li class="@yield('size_select')">
        <a href="{{url('admin/category')}}">
            <i class="fas fa-window-maximize"></i>Jobs Category</a>
    </li>

    <li class="@yield('brand_select')">
        <a href="{{url('admin/cuntry')}}">
        <i class="fa fa-product-hunt"></i>cuntry</a>
    </li>

    <li class="@yield('color_select')">
        <a href="{{url('admin/Department')}}">
        <i class="fas fa-paint-brush"></i>Department</a>
    </li>

    <li class="@yield('tax_select')">
        <a href="{{url('admin/tax')}}">
        <i class="fas fa-percent"></i>Newspapaer</a>
    </li>

    <li class="@yield('product_select')">
        <a href="{{url('admin/product')}}">
        <i class="fal fa-clipboard-list"></i>jobs Posts</a>
    </li>
...
<ul class="list-unstyled navbar__list">
    ...
    <li class="@yield('brand_select')">
        <a href="{{url('admin/cuntry')}}">
        <i class="fa fa-bold"></i>cuntry</a>
    </li>

    <li class="@yield('color_select')">
        <a href="{{url('admin/Department')}}">
        <i class="fa fa-building"></i>Department</a>
    </li>

    <li class="@yield('tax_select')">
        <a href="{{url('admin/tax')}}">
        <i class="fas fa-percent"></i>News paper</a>
    </li>

    <li class="@yield('product_select')">
        <a href="{{url('admin/product')}}">
        <i class="fa fa-list"></i></i>jobs posts</a>
    </li>
    ...
    <li class="@yield('home_banner_select')">
        ...
        <i class="fa fa-building"></i>Education</a>
    </li>
