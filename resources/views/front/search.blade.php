...
<head>
  ...
  <title>jobtody | jobs in {{Request::get('search')}}
    <?php echo date('Y'); ?>
  </title>
...
<span style="font-size: 24px; line-height: 30px;">
        ...
        <div id="main-container">
          <div id="middle-container">
            <div id="breadcrumb_container" class="breadcrumb_container">
              <ul id="breadcrumbs">
                <li></li>
                <li><a href="{{url('/')}}">Home</a></li>{{Request::get('search')}}</ul>
            </div>
            <div class="listings" style="position: relative;">
              <h1>Latest {{Request::get('search')}} <?php echo date('Y')?></h1>
              <div class="fclear"></div>
              <p>We have new October 2022 Ff Jobs, September 2022 and August 2022 jobs from all cities including Karachi, Lahore, Rawalpindi, Islamabad, Faisalabad, Multan, Hyderabad, Quetta, Peshawar, Gujrat, Sahiwal, Gujranwala, Punjab, KPK, Sindh, Balochistan etc</p>
              <div class="fclear"></div>
              ...
              <h2>Latest Job Opportunities in '{{Request::get('search')}}' 2022 Pakistan</h2>
  ...
  @endforeach
            ...
            <div class="fclear"></div>
              <div class="table">
                <h3>More jobs By Category in <?php echo date('Y');?></h3>
          ...
          <div id="right-container-temp2">
            ...
            <div class="table">
              ...
              <div class="table_contents">
                ...
                <div class="table_cell">
                  <a href="{{url('defartment'.$list->def_slug)}}">{{$list->department}}</a>
                </div>
                @endforeach
              </div>
            </div>
...
<div class="table_contents" style="height: 50%;">
              ads by Google  
              </div>
            </div>
