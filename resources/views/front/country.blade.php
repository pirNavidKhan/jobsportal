...
<head>
  ...
  <meta name="description" content="{{$country_jobs[0]->cate_desc}}">
  <meta name="keywords" content="{{$country_jobs[0]->cate_key}}">
...
<body>
        ...
        <div id="main-container">
          <div id="middle-container">
            <div id="breadcrumb_container" class="breadcrumb_container">
              <ul id="breadcrumbs">
                <li></li>
                <li><a href="{{url('/')}}">Home</a></li>{{$country_jobs[0]->cu_slug}}</ul>
            </div>
            <div class="listings" style="position: relative;">
              <h1>Job Opportunities in {{$country_jobs[0]->cu_name}}</h1>
              <div class="fclear"></div>
              <p>{{$country_jobs[0]->cate_desc}}</p>
              <div class="fclear"></div>
              ...
              <h2>Latest Job Opportunities in {{$country_jobs[0]->cu_name}} <?php echo date('Y');?></h2>
  ...
  @endforeach
            ...
            <br>
                ...
                <h2>Latest jobs in {{$country_jobs[0]->city_name}} <?php echo date('Y');?></h2>
                <p>{{$country_jobs[0]->c_desc}}</p><hr>
                <br>
                <div class="row_cont_onecell">
                  @foreach($all_Category as $list)
                  <div class="table_cell">
                    <a href="{{url('search/jobs')}}?search={{$list->cate_name}}+jobs+in+{{$country_jobs[0]->cu_name}}">
                      {{$list->cate_name}} jobs in {{$country_jobs[0]->cu_name}}
                    </a>
          ...
          <div id="right-container-temp2">
            ...
            <div class="table">
            <div class="table_tittle">More jobs by Category</div> 
